...
BEGIN
    ...
    -- Insertar en USUARIO (Ajustado a la columna 'contraseña')
...
-- ============================================================
-- Procedimiento almacenado para crear un nuevo empleado
-- ============================================================
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- 1. Crear usuario (Ajustado a la columna 'contraseña')
        INSERT INTO USUARIO (usuario, contraseña, Rol, Activo, Ultimo_acceso)
        ...
        INSERT INTO EMPLEADO (
            Id_usuario, Nombre, Apellido_Paterno, Apellido_Materno,
            Tipo_empleo, Curp, Correo, Telefono, Fecha_contratacion
        )
        VALUES (
            @id_usuario, @Nombre, @Apellido_Paterno, @Apellido_Materno,
            @Rol, @Curp, @Correo, @Telefono, @Fecha_contratacion
        );
